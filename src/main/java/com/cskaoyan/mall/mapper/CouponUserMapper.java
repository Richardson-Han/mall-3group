...
public interface CouponUserMapper {
    ...
    List<CouponUser> listuserCouponUser(Integer couponId);

    List<CouponUser> listuserUserIdCouponUser(@Param("userId") Integer userId,@Param("couponId")Integer couponId);
}